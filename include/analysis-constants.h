...
const int std_marker_style_jet_pt[]  = {42,46,40,45,24,25,27,24,25,27,42,46,40,45,49};
const int corr_marker_style_jet_pt[] = {43,47,41,45,20,21,33,20,21,33,43,47,41,45,49};

const int std_marker_color_jet_pt[]  = {868,797,618,41,46,38,418,861,617,1,8,9};
const int corr_marker_color_jet_pt[] = {868,797,618,41,46,38,418,861,617,1,8,9};
