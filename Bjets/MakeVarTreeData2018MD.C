...
#include "../include/TBJetsData2018MD.h"
#include "../include/TBJetsData2018MD.C"
...
void MakeVarTreeData2018MD(bool DoJetID = false)
{
        ...
        TFile* file_pideffK       = new TFile(eff_path + "PIDEff/effhists-Turbo2018_MD-K-Brunel_DLLK>0-P.ETA.nTracks_Brunel.root", "READ");
        TFile* file_pideffMu      = new TFile(eff_path + "PIDEff/effhists-Turbo2018_MD-Mu-IsMuon&Brunel_DLLmu>0-P.ETA.nTracks_Brunel.root", "READ");
        ...
        TBJetsData2018MD Tree;
        
        double NumEvts = Tree.fChain->GetEntries();
        
        std::string output_file_name = (DoJetID) ? "ntuple_bjets_data_2018_MD_jetid.root" : "ntuple_bjets_data_2018_MD_nominal.root";
