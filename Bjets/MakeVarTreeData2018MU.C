...
#include "../include/TBJetsData2018MU.h"
#include "../include/TBJetsData2018MU.C"

using namespace fastjet;
using namespace std;

void MakeVarTreeData2018MU(bool DoJetID = false)
{
        ...
        TFile* file_trackeff      = new TFile(eff_path + "TrackEff/trackEff_2018_Ratio_Full_Long_method.root"     , "READ");
        TFile* file_trackeff_Muon = new TFile(eff_path + "TrackEff/trackEff_Muon_2018_Ratio_Full_Long_method.root", "READ");
        TFile* file_trackeff_Data = new TFile(eff_path + "TrackEff/trackEff_2018_Data_Full_Long_method.root"      , "READ");
        TFile* file_trackeff_MC   = new TFile(eff_path + "TrackEff/trackEff_2018_MC_Full_Long_method.root"        , "READ");
        
        TFile* file_pideffK       = new TFile(eff_path + "PIDEff/effhists-Turbo2018_MU-K-Brunel_DLLK>0-P.ETA.nTracks_Brunel.root", "READ");
        TFile* file_pideffMu      = new TFile(eff_path + "PIDEff/effhists-Turbo2018_MU-Mu-IsMuon&Brunel_DLLmu>0-P.ETA.nTracks_Brunel.root", "READ");
        ...
        TBJetsData2018MU Tree;
        
        double NumEvts = Tree.fChain->GetEntries();
        
        std::string output_file_name = (DoJetID) ? "ntuple_bjets_data_2018_MU_jetid.root" : "ntuple_bjets_data_2018_MU_nominal.root";
