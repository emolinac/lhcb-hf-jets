...
void PrintBreakdownRelSyst2TotalRelSyst()
{
        ...
        for (int bin = 0 ; bin < ptbinsize ; bin++) {
                ...
                set_histoa_relerrors_as_histob_content(hcorr_eec_syst[bin],hcorr_eec_syst[bin]);
        ...
        for (int i = 0 ; i < ptbinsize ; i++) {
                ...
                c->Print(Form("./plots/breakdown_relsyst_2_totalrelsyst_jetpt%i.pdf",i));
        }
}