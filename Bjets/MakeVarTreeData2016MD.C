...
#include "../include/TBJetsData2016MD.h"
#include "../include/TBJetsData2016MD.C"

using namespace fastjet;
using namespace std;

void MakeVarTreeData2016MD(bool DoJetID = false)
{
        ...
        TFile* file_pideffK       = new TFile(eff_path + "PIDEff/effhists-Turbo2016_MD-K-Brunel_DLLK>0-P.ETA.nTracks_Brunel.root", "READ");
        TFile* file_pideffMu      = new TFile(eff_path + "PIDEff/effhists-Turbo2016_MD-Mu-IsMuon&Brunel_DLLmu>0-P.ETA.nTracks_Brunel.root", "READ");
        ...
        TBJetsData2016MD Tree;
        
        double NumEvts = Tree.fChain->GetEntries();
        
        std::string output_file_name = (DoJetID) ? "ntuple_bjets_data_2016_MD_jetid.root" : "ntuple_bjets_data_2016_MD_nominal.root";
