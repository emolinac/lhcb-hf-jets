...
void macro_print_deadcone_eec_mc(const int bin = 0)
{
        ...
        for (int bin = 0 ; bin < 3 ; bin++) {
                h_heavy[bin] = (TH1F*) f_heavy->Get(Form("hmc_eec%i", bin + 4));
                ...
                h_heavy_data[bin] = (TH1F*) f_heavy->Get(Form("hdata_eec%i", bin + 4));
