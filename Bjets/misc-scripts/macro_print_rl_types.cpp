...
void macro_print_rl_types()
{
        ...
        TH1F* h_mc = new TH1F("h_mc", "", nbin_rl_nominal, rl_nominal_binning);
        TH1F* h_mcreco = new TH1F("h_mcreco", "", nbin_rl_nominal, rl_nominal_binning);
        TH1F* h_data = new TH1F("h_data", "", nbin_rl_nominal, rl_nominal_binning);
        ...
        t_mc->Project("h_mc","pair_rl",Form("jet_pt>%f&&jet_pt<%f", 20., 100.));
        t_mcreco->Project("h_mcreco","pair_rl",Form("jet_pt>%f&&jet_pt<%f", 20., 100.));
        t_data->Project("h_data","pair_rl",Form("jet_pt>%f&&jet_pt<%f", 20., 100.));
